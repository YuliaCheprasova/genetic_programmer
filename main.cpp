...
int main()
{
    ...
    for(general = 0; general < num_generals; general++)
    {
        ...
        for(i = 0; i < n; i++)
        {
            cout << "Tree " << i <<endl;
            //tree[i].PrintTree();
            cout << "Выражение " << delete_brackets(tree[i].printExpression()) << endl;
